...
const producerSearch = async (query, offset) => {
  ...
  return selectedProducers.map(({ account_name, title, tagline, org, introduce }) =>
    ({
      ...
      // (org.hasOwnProperty('social_network') && org.social_network.hasOwnProperty('github') ? `github: ${org.social_network.github} \n` : '') +
      // (org.hasOwnProperty('social_network') && org.social_network.hasOwnProperty('twitter') ? `twitter: ${org.social_network.twitter} \n` : '') +
